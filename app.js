...
var dropdownLabel = document.getElementById("dropdown-label6");
...
var dropdownLabel1 = document.getElementById("dropdown-label1");
var dropdownFood1 = document.getElementById("dropdown-food1");
function kreditDropdown() {
  dropdownFood1.classList.toggle("is-open");
}
document.formFood1.onclick = function () {
  var selectedFood1 = document.querySelector(
    "input[name = selected-food1]:checked"
  );
  if (selectedFood1 != null) {
    var span = selectedFood1.parentNode.querySelector("span").innerHTML;
    dropdownLabel1.innerHTML = span;
    dropdownFood1.classList.remove("is-open");
  }
};

var dropdownLabel2 = document.getElementById("dropdown-label2");
var dropdownFood2 = document.getElementById("dropdown-food2");
function lokalDropdown() {
  dropdownFood2.classList.toggle("is-open");
}
document.formFood2.onclick = function () {
  var selectedFood2 = document.querySelector(
    "input[name = selected-food2]:checked"
  );
  if (selectedFood2 != null) {
    var span = selectedFood2.parentNode.querySelector("span").innerHTML;
    dropdownLabel2.innerHTML = span;
    dropdownFood2.classList.remove("is-open");
  }
};
var dropdownLabel3 = document.getElementById("dropdown-label3");
var dropdownFood3 = document.getElementById("dropdown-food3");
function virtualDropdown() {
  dropdownFood3.classList.toggle("is-open");
}
document.formFood3.onclick = function () {
  var selectedFood3 = document.querySelector(
    "input[name = selected-food3]:checked"
  );
  if (selectedFood3 != null) {
    var span = selectedFood3.parentNode.querySelector("span").innerHTML;
...
/////kalkulyator
var dropdownLabel5 = document.getElementById("dropdown-label5");

var dropdownFood5 = document.getElementById("dropdown-food5");
...
document.formFood5.onclick = function () {
  var selectedFood5 = document.querySelector(
    "input[name = selected-food5]:checked"
  );
  if (selectedFood5 != null) {
    var span = selectedFood5.parentNode.querySelector("span").innerHTML;
